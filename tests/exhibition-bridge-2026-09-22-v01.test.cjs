...
const source = fs.readFileSync('code/artworks/exhibition-bridge-2026-09-22-v01.js', 'utf8');
...
function fixture(stage = 'liven') {
  ...
  const context = vm.createContext({
    ...
    location: { pathname: `/repo/artworks/${stage}/index-2026-09-22-v01.html`, search: '?exhibition=heal', origin: 'http://localhost' },
