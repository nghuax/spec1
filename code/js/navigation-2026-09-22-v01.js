import { siteContent } from './content-2026-09-22-v01.js';
...
function chapterLink(chapter, root, currentChapter) {
  ...
  return `
    <a class="site-nav__chapter ${exhibition ? 'exhibition-progress' : ''} ${before ? 'is-before' : ''}" href="${route(root, `works/${chapter.id}-2026-09-22-v01.html`)}"
...
export function renderNavigation() {
  ...
  host.innerHTML = `
    <nav class="site-nav" aria-label="Primary navigation">
      <a class="site-nav__brand" href="${route(root, 'index-2026-09-22-v01.html')}" aria-label="HEAL home">HEAL</a>
      ...
      <div class="site-nav__links" id="mobile-navigation">
        ...
        <a class="site-nav__about" href="${route(root, 'about-2026-09-22-v01.html')}"
...
export function renderFooter() {
  ...
  host.innerHTML = `
    ...
    <a href="${route(root, 'about-2026-09-22-v01.html')}#credits">CREDITS</a>`;
}
