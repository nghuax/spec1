import { stages } from './exhibition-content-2026-09-22-v01.js';
import { healMark } from './heal-mark-2026-09-22-v01.js';
import { endings, EndingSequence } from './artwork-endings-2026-09-22-v01.js';
import { SectionScroll } from './section-scroll-2026-09-22-v01.js';
import { MotionPreference, LivingMotion } from './living-motion-2026-09-22-v01.js';
import { introMarkup, briefMarkup, StageIntros } from './stage-intros-2026-09-22-v01.js';
import { Installation } from './installation-2026-09-22-v01.js';
import { LogoFlight } from './logo-flight-2026-09-22-v01.js';
import { UISounds } from './ui-sounds-2026-09-22-v01.js';
  ...
  <section id="${stage.id}" class="chapter" data-section aria-labelledby="${stage.id}-title">
    ...
    <dialog open class="chapter-inner" id="${stage.id}-artwork" role="region" aria-labelledby="${stage.id}-artwork-title">
      ...
      <div class="artwork-frame" aria-busy="true">
        <div class="artwork-viewport"><iframe title="${stage.title} — interactive artwork by ${stage.artist}" data-src="artworks/${stage.id}/index-2026-09-22-v01.html?exhibition=heal" allow="fullscreen" allowfullscreen tabindex="-1"></iframe></div>
        <div class="artwork-loading" role="status"><strong>${stage.title}</strong><p>Preparing the artwork…</p></div>
        <div class="artwork-error" role="alert" hidden><p>The artwork could not load.</p><button data-action="retry">TRY AGAIN</button><a href="artworks/${stage.id}/index-2026-09-22-v01.html">OPEN THE ORIGINAL ARTWORK ↗</a></div>
      </div>
